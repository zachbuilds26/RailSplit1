...
export function PaymentLinkForm() {
  ...
  const receipt = useWaitForTransactionReceipt({ hash, chainId: railsplitChain.id });
            ...
            <label className="grid gap-2 text-sm">
              ...
              {errors.amount ? (
                ...
                <span id="amount-hint" className="text-xs leading-5 text-muted">
                  Stored onchain as {priceUsdCents.toString()} cents. Keep testnet amounts small so a
                  faucet balance can cover them.
                </span>
              )}
            </label>
        ...
        <aside className="h-fit border border-line bg-background-deep p-5 sm:p-6">
          ...
          <div className="mt-5 border border-line bg-surface p-5">
            ...
            <div className="mt-6 border-y border-line py-4">
              ...
              {previewWei !== undefined && priceUsdCents > 0 && (
